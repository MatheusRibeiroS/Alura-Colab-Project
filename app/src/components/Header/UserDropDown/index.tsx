    ...
    <Menu as="div" className="relative inline-block text-left">
      {({ open }) => (
        <>
          ...
          >
            <Menu.Items className="w-36 text-center origin-top-right absolute right-0 mt-2 rounded-md shadow-lg bg-white ring-1 ring-black ring-opacity-5 focus:outline-none">
